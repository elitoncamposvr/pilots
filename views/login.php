...
<body>
  ...
  <div class="container">
    ...
    <form method="POST">
      ...
      <?php endif; ?>
      <input type="text" name="cpf" id="cpf" placeholder="CPF" autocomplete="off" required autofocus>
      <input type="date" name="birth_date" id="birth_date" placeholder="Data de Nascimento" required>
